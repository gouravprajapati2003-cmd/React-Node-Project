...
//                 <Form.Control type="text" onChange={ (e)=> setVehicleColor(e.target.value)}></Form.Control>
//             </Form.Group>
//             <Form.Group>
...
//                 <Form.Control type="text" onChange={ (e)=> setVehicleNumber(e.target.value)}></Form.Control>
//             </Form.Group>
//             <Button variant="success" className='mt-3' onClick={addVehicle}>Add Vehicle</Button>
//             </Form>
//             </Col>
//             </Row>
//         </Container>
